      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div>
          ...
          >
            <Link
              to="/ContactUs"
              className="bg-[#0056ff] text-white px-6 py-3 rounded-md font-semibold flex items-center gap-2 hover:bg-[#0046d4] transition-all duration-300 shadow-lg hover:shadow-xl inline-flex"
            >
              Talk to Our Experts
